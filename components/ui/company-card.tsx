  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 p-2 sm:p-4 flex flex-col justify-center opacity-0 group-hover:opacity-95 transition-all duration-300 border-2" style={{ backgroundColor: 'var(--mint)', borderColor: 'var(--mint)', color: 'var(--mint-ink)' }}>
        <h3 className="text-sm sm:text-base md:text-lg font-bold text-center mb-1 sm:mb-2 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300" style={{ color: 'var(--mint-ink)', fontFamily: 'var(--font-display), var(--font-outfit), sans-serif' }}>
          {company.name}
        </h3>
