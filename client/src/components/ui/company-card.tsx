...
export default function CompanyCard({ company }: CompanyCardProps) {
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-green-400 border-4 border-black p-4 flex flex-col justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300"
           style={{ boxShadow: '6px 6px 0px 0px #000000' }}>
