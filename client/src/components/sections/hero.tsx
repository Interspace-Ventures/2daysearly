      ...
      <div className="container mx-auto">
        <AnimatedSection className="text-center w-full max-w-4xl mx-auto" delay={0.2}>
          <div className="neo-card p-8 mx-4">
            <div className="bg-green-400 neo-border neo-shadow p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
              ...
              <div className="bg-green-600 neo-border neo-shadow p-4">
                <div className="text-white font-bold text-xl font-mono">BUILD</div>
                <div className="text-white font-mono text-sm">TOGETHER</div>
              </div>
              <div className="bg-green-800 neo-border neo-shadow p-4">
